...
public abstract class PircBot implements ReplyConstants {
     ...
     * will filteredResult in no output. For general development, we strongly recommend
     ...
     * The filteredResult of this method should only act as a rough guide,
     * as the filteredResult may not be valid by the time you act upon it.
     *
     ...
     * Attempting to use a PircBot that has been disposed may filteredResult in
