...
public class MoveSetGenerator {
    ...
    public static void main(String[] args) {
        List<String> targetPool = Arrays.asList("Í·", "Í·", "ÐØ", "ÐØ", "ÐØ", "ÐØ", "¸¹", "¸¹", "×ó±Û", "ÓÒ±Û", "×óÍÈ", "ÓÒÍÈ");

        Map<String, Integer> protectPool = new HashMap<String, Integer>();
        protectPool.put("Í·", 15);
        protectPool.put("ÐØ", 15);
        protectPool.put("¸¹", 15);
        protectPool.put("±³", 5);
        protectPool.put("×ó±Û", 12);
        protectPool.put("ÓÒ±Û", 12);
        protectPool.put("×óÍÈ", 12);
        protectPool.put("ÓÒÍÈ", 12);

        List<List<Protect>> protectArray = new ArrayList<List<Protect>>(targetPool.size());
        for (int i = 0; i < 7; i++) {
            List<Protect> protects = new ArrayList<Protect>(8);
            protects.add(new Protect("ÉÁ±Ü", 3));
            protects.add(new Protect("¸ñµ²", 3));
            protects.add(new Protect("¸ñµ²", 1));
            protects.add(new Protect("¸ñµ²", 1));
        ...
        for (int i = 0; i < 7; i++) {
            ...
            protects.add(new Protect("¸ñµ²", 3));
            protects.add(new Protect("¸ñµ²", 3));
            protects.add(new Protect("ÉÁ±Ü", 1));
            protectArray.add(protects);
        }
