...
public class MainFrame extends JFrame {
    ...
    public MainFrame(ReadonlyContext context) {
        ...
        jTabbedPane
                .addTab("<html><body leftmargin=12 topmargin=2 marginwidth=12 marginheight=2><font size=+0>绘制</font></body></html>",
                        createEditingPanel());
        jTabbedPane
                .addTab("<html><body leftmargin=12 topmargin=2 marginwidth=12 marginheight=2><font size=+0>展现</font></body></html>",
                        createViewingPanel());
