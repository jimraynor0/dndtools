...
public abstract class MapFilter {
    ...
    public static final String TYPE_AXIS_LABEL_FILTER = "坐标滤镜";
    public static final String TYPE_INVISIBILITY_FILTER = "隐形滤镜";
    public static final String TYPE_LINE_OF_SIGHT_FILTER = "可视范围滤镜";
    public static final String TYPE_CROP_FILTER = "截取滤镜";
